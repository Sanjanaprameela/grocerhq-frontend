...
function Cart() {
  ...
  const incrementQuantity = async (id) => {
    try {
      ...
      if (
        parseInt(cartItem.cart.quantity) < parseInt(cartItem.product.quantity)
      ) {
        cartItem.cart.quantity = (
          parseInt(cartItem.cart.quantity) + 1
        ).toString();
        await axiosInstance.put(`/cart/update/${id}`, cartItem.cart);
      } else {
                              ...
                              <tr key={index}>
                                <td>
                                  <figure className="itemside align-items-center">
                                    <div className="aside">
                                      <img
                                        src={`${process.env.PUBLIC_URL}/assets/assets/${item.product.image}`}
                                  ...
                                  <div className="input-group input-group-sm ">
                                    <div className="input-group-prepend">
                                      <button
                                        ...
                                        data-abc="true"
                                        onClick={() =>
                                          decrementQuantity(item.cart._id)
                                        }
                                      >
                                    ...
                                    <div className="input-group-append">
                                      <button
                                        ...
                                        data-abc="true"
                                        onClick={() =>
                                          incrementQuantity(item.cart._id)
                                        }
                                      >
                                ...
                                <td className="text-right d-none d-md-block">
                                  ...
                                  <a
                                    className="btn btn-light"
                                    data-abc="true"
                                    onClick={() => removeItem(item.cart._id)}
                                  >
                                    {" "}
                                    Remove
                                  </a>{" "}
                      ...
                      <div className="input-group">
                        ...
                        <div className="input-group-append col-md-6">
                          <span className="mt-3 m-auto ">
                            <button className="btn btn-primary btn-apply coupon mt-3">
                              Apply
                            </button>
                          </span>
                        </div>
              ...
              <div className="card">
                <div className="card-body">
                  <dl className="dlist-align">
                    ...
                    <dd className="text-right ml-3">
                      {totalAndDiscount.total
                        ? `$${parseFloat(totalAndDiscount.total).toFixed(2)}`
                        : "0.00"}
                    </dd>
                  </dl>
                  <dl className="dlist-align">
                    ...
                    <dd className="text-right text-danger ml-3">
                      ...
                      {totalAndDiscount.discount
                        ? `$${parseFloat(totalAndDiscount.discount).toFixed(2)}`
                        : "$0.00"}
                    </dd>
                  </dl>
                  <dl className="dlist-align">
                    ...
                    <dd className="text-right text-dark b ml-3">
                      <strong>
                        {totalAndDiscount.total
                          ? `$${parseFloat(
                              totalAndDiscount.total - totalAndDiscount.discount
                            ).toFixed(2)}`
                          : "$0.00"}
                      </strong>
                    </dd>
                  ...
                  <div className="text-center">
                    <a
                      style={{
                        display: `${cartData?.length < 1 ? "none" : ""}`,
                      }}
